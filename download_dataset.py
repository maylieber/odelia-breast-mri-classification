...
# Requires a Hugging Face access token (huggingface.co/settings/tokens)
# with access to the ODELIA-AI/ODELIA-Challenge-2025 dataset. Set it as
# an environment variable rather than hardcoding it here:
...
output_root = Path("D:/dataset_downloaded")
