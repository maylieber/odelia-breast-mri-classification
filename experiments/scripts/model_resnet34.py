"""
Comparison against the reference configuration: ImageNet-pretrained ResNet34
...
class BreastMRINetworkResNet34(nn.Module):

    def __init__(self):

        super().__init__()

        self.feature_extractor = ResNet34FeatureExtractor()
