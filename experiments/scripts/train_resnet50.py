...
Baseline backbone-family comparison against the reference configuration:
...
ImageNet-pretrained ResNet50 (model_resnet50.py's BreastMRINetworkResNet50,
2048-d features).
"""
...
from model_resnet50 import BreastMRINetworkResNet50
